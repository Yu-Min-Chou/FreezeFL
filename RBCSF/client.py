...
class Client:
    ...
    def __init__(self, client_id, train_data={'x' : [],'y' : []}, test_data={'x' : [],'y' : []}, model=None, ability = 1, selected_probability = 0):
        self._model = model
        self.id = client_id
    ...
    def train(self, num_local_epochs, profile_result):
        ...
        update = self.model.fair_train(self.train_dataset, num_local_epochs)
